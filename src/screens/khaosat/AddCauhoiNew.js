...
class AddCauhoiNew extends Component {
    constructor(props) {
        super(props);
    ...
    _post = async () => {
        ...
        const listCauHoi = this.state.listCauHoi.slice();
        if (textContent.length == 0) {
            Utils.showMsgBoxOK(this, 'Thông báo', 'Vui lòng thêm nội dung câu hỏi')
            return;
        }
        listCauHoi.push({
            loai: anser,
        ...
        Utils.showMsgBoxOK(this, 'Thông báo', 'Thêm câu hỏi thành công', 'Đóng', () => this._handleOK(listCauHoi))
    }
    _handleOK = (data) => {
        this.callBack(data);
        Utils.goback(this)
                        ...
                        <View style={{ backgroundColor: 'white', padding: 20 }}>
                            ...
                            <View style={[nstyles.nrow, stHoctap.container]}>
                                <View style={{ flex: 1, }}>
                                    ...
                                    <Picker
                                        mode="dropdown"
                                        placeholder={'Câu hỏi Đồng ý/Không đồng ý'}
...
export default Utils.connectRedux(AddCauhoiNew, mapStateToProps, true);
